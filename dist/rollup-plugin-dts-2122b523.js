...
var require$1 = (
			false
				? /* @__PURE__ */ module$1.createRequire((typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('rollup-plugin-dts-2122b523.js', document.baseURI).href)))
				: require
		);
...
function getLocalTypescriptPath() {
  ...
  try {
    return require$1.resolve("typescript", {
      paths: [cwd]
    });
  } catch {
...
var ts = require$1(getLocalTypescriptPath());
...
function getCodeFrame() {
    ...
    try {
        ({ codeFrameColumns } = require$1("@babel/code-frame"));
        return codeFrameColumns;
    }
    catch {
        try {
            const esmRequire = module$1.createRequire((typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('rollup-plugin-dts-2122b523.js', document.baseURI).href)));
