...
var require$1 = (
			false
				? require$$2.createRequire((typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('rollup-plugin-dts-7f59a15a.js', document.baseURI).href)))
				: require
		);
...
function getCodeFrame() {
    ...
    try {
        ...
        try {
            const esmRequire = require$$2.createRequire((typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('rollup-plugin-dts-7f59a15a.js', document.baseURI).href)));
